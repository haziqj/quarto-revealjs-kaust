...
The [**KAUST reveal.js**]{.text-tur}^[reveal.js is an open source HTML presentation framework. It's a tool that enables anyone with a web browser to create fully-featured and beautiful presentations for free.] [**Theme**]{.text-mer} is a modern and minimal theme designed for getting information across in a clean and uncluttered manner.

This theme is based on the [Quarto Clean Theme ](https://github.com/grantmcdermott/quarto-revealjs-clean) by [Grant McDermott](https://grantmcdermott.com), with its logos and fonts changed, and colour scheme adapted to KAUST's official brand colours.

This document was created using [quarto](https://quarto.org/docs/presentations/revealjs/). 
Check out the source code [here](https://github.com/haziqj/quarto-revealjs-kaust/blob/b71f1a2f7893ded8114a7879efd288457b47cc33/template.qmd)
...
This is a `{.transition-slide}` transition slide.
...
- I've also added some convenient CSS classes, e.g. `.text-tur`, `.text-mer`, `.text-org`, etc.
...
The Quarto reveal.js [KAUST theme](https://github.com/haziqj/quarto-revealjs-kaust) aims to be a minimal and elegant presention theme.
